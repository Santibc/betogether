        ...
        <div class="drawer-fixed-header">
            <div class="drawer-header">
                ...
                <div class="drawer-close">
                    <button type="button" class="drawer-close-btn" aria-label="Close"><span class="drawer-close-icon"><i
            ...
            <div class="drawer-scrollable">
                <ul class="cart-items">
                    <li class="cart-item">
                        <div class="cart-item-wrap">
                            <div class="cart-item-image">
                                <a href="product-template.html"><img src="image/home1/cart/cart-1.jpg" class="img-fluid"
                                        alt="p-1"></a>
                            </div>
                    ...
                    <li class="cart-item">
                        <div class="cart-item-wrap">
                            <div class="cart-item-image">
                                <a href="product-template.html"><img src="image/home1/cart/cart-2.jpg" class="img-fluid"
                                        alt="p-7"></a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-info">
                    ...
                    <li class="cart-item">
                        <div class="cart-item-wrap">
                            <div class="cart-item-image">
                                <a href="product-template.html"><img src="image/home1/cart/cart-3.jpg" class="img-fluid"
                                        alt="p-9"></a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-info">
                                    <div class="cart-item-name">
                                        <a href="product-template.html">Router Wi-Fi 7</a>
                                    </div>
                                    <div class="cart-item-variants">
                                        <h6>Size:</h6>
                                        <span>S</span>
                    ...
                    <li class="cart-item">
                        <div class="cart-item-wrap">
                            <div class="cart-item-image">
                                <a href="product-template.html"><img src="image/home1/cart/cart-4.jpg"
                                        class="img-fluid" alt="p-12"></a>
                            </div>
                            <div class="cart-item-details">
                                <div class="cart-item-info">
                                    <div class="cart-item-name">
                                        <a href="product-template.html">Smart phone</a>
                                    </div>
                                    <div class="cart-item-variants">
                                        <h6>Size:</h6>
                                        <span>S</span>
